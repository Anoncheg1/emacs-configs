...
# (global-set-key "\C-x3" (lambda () (interactive)(select-window (split-window-horizontally))))
# (global-set-key "\C-x2" (lambda () (interactive)(select-window (split-window-vertically))))
